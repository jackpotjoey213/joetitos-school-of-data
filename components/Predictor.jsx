      ...
      if(updates&&Array.isArray(updates)){
        ...
        const ug=games.map(g=>{
          ...
          adj[g.id]={
            ...
            claudePred: u.claudePred || u.lockedPrediction?.claudePred || null,
          ...
          if (u.isNewPrediction && u.consensus) {
            lockPrediction(g.id, {
              ...
              predAway: u.claudePred?.away || u.geminiPred?.away || 0,
              predHome: u.claudePred?.home || u.geminiPred?.home || 0,
              line: u.currentTotal || ng.total,
              consensus: u.consensus,
              claudePred: u.claudePred,
