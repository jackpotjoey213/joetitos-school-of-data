        ...
        {liveAdj?.consensus ? (
          <div style={{ background:"#10b98110",border:"1px solid #10b98130",borderRadius:"10px",padding:"12px" }}>
            ...
            {(() => {
              ...
              // O/U edge rating
              const ouThreshStrong = isNBA ? 5 : 2;
              const ouThreshLean = isNBA ? 2 : 0.5;
              ...
              return (
                <div style={{ display:"flex",flexDirection:"column",gap:"6px",marginBottom:"10px" }}>
                  ...
                  <div style={{ display:"flex",gap:"6px",justifyContent:"center",alignItems:"center",flexWrap:"wrap" }}>
                    ...
                    <span style={{ background:ouColors.bg, color:ouColors.color, border:`1px solid ${ouColors.border}`, padding:"3px 8px", borderRadius:"6px", fontSize:"9px", fontWeight:700 }}>{ouColors.label} ({edge.toFixed(1)}{isNBA?" pts":" runs"})</span>
                  </div>
...
function RecordTracker({ history, weights, sport }) {
  if (!history.length) return (
    <div style={{ margin:"0 12px 10px",padding:"12px 14px",borderRadius:"12px",background:"var(--card-bg)",border:"1px solid var(--border)",textAlign:"center" }}>
      <span style={{ fontSize:"11px",color:"var(--muted)" }}>No {sport?.toUpperCase()} predictions tracked yet — hit Refresh before games start to begin recording</span>
    </div>
  );
