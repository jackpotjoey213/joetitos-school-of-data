...
const LEAGUE_SCORING_ADJUSTMENT = 0.92;
...
export async function GET(req) {
  ...
  try {
    ...
    for (const g of gamesToProcess) {
      ...
      // Pitcher model total (with calibrations)
      const regressedAwayERA = (awayERA + LEAGUE_AVG_ERA) / 2;
      const regressedHomeERA = (homeERA + LEAGUE_AVG_ERA) / 2;
