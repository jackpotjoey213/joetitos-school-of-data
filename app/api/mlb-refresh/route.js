...
// --- CALIBRATION CONSTANTS (v2 - post backtest #2) ---
const LEAGUE_SCORING_ADJUSTMENT = 0.85; // Backtest Apr 18-21 confirmed 2026 scoring suppression
const LEAGUE_AVG_ERA = 4.10;
const ERA_REGRESSION_WEIGHT = 0.70;
const ELITE_ERA_THRESHOLD = 3.50;  // Hard-cap trigger
const PITCHING_HARD_CAP = 8.50;    // Max total when both starters are elite
