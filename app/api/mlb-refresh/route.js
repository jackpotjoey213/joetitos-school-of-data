...
const LEAGUE_SCORING_ADJUSTMENT = 1.0; // Removed: was 0.92 but model now runs 2.6 runs LOW
const LEAGUE_AVG_ERA = 4.10; // 2026 MLB league average ERA
const ERA_REGRESSION_WEIGHT = 0.70; // 70% raw ERA, 30% league avg (was 50/50 — too aggressive)
