...
const INITIAL_GAMES = [
  {
    id: 1, away: "Vanderbilt", home: "Florida", awayAbbr: "VAN", homeAbbr: "FLA",
    awayRecord: "25-7", homeRecord: "26-6", conference: "SEC Tournament", time: "10:00 AM PT",
    status: "final", liveScore: { away: 91, home: 74, clock: "FINAL" },
    spread: { fav: "FLA", line: -6.5 }, total: 160.5, moneyline: { away: 270, home: -340 },
    stats: {
      awayPPG: 78.2, homePPG: 82.1, awayOPPG: 70.5, homeOPPG: 66.8,
      awayPace: 69.2, homePace: 67.8, awayFGPct: 0.462, homeFGPct: 0.478,
      away3Pct: 0.351, home3Pct: 0.368, awayFTPct: 0.752, homeFTPct: 0.781,
      awayRebPG: 36.8, homeRebPG: 38.2, awayTOPG: 11.2, homeTOPG: 9.8,
      awayAdjOE: 118.5, homeAdjOE: 124.2, awayAdjDE: 101.3, homeAdjDE: 96.5,
      awayHomeRec: "13-3 Away", homeHomeRec: "14-1 Home", awayLast5: "4-1", homeLast5: "5-0",
      awayATS: "4-2 vs FLA / UP 10 AT HALF — shooting hot", homeATS: "5-1 last 6 / DOWN 10 struggling",
      h2hTrend: "FLA leads 12-3 last 15", overTrend: "OVER in 5 of last 7 VAN games"
    }
  },
  {
    id: 2, away: "Wisconsin", home: "Michigan", awayAbbr: "WIS", homeAbbr: "MICH",
    awayRecord: "24-9", homeRecord: "30-2", conference: "Big Ten Semi", time: "10:00 AM PT",
    status: "final", liveScore: { away: 65, home: 68, clock: "FINAL" },
    spread: { fav: "MICH", line: -12.5 }, total: 162.5, moneyline: { away: 625, home: -950 },
    stats: {
      awayPPG: 83.3, homePPG: 88.4, awayOPPG: 75.8, homeOPPG: 68.2,
      awayPace: 71.5, homePace: 72.8, awayFGPct: 0.453, homeFGPct: 0.511,
      away3Pct: 0.363, home3Pct: 0.387, awayFTPct: 0.785, homeFTPct: 0.794,
      awayRebPG: 35.7, homeRebPG: 37.5, awayTOPG: 8.9, homeTOPG: 10.1,
      awayAdjOE: 120.1, homeAdjOE: 129.8, awayAdjDE: 103.5, homeAdjDE: 94.8,
      awayHomeRec: "15-2 Away", homeHomeRec: "14-1 Home", awayLast5: "4-1", homeLast5: "5-0",
      awayATS: "Blackwell 34pts last / LEADING at half", homeATS: "90-80 W vs MSU / DOWN 3 at half",
      h2hTrend: "MICH #1 in most rating systems", overTrend: "OVER in 4 of last 5 MICH games"
    }
  },
  {
    id: 3, away: "Penn", home: "Harvard", awayAbbr: "PENN", homeAbbr: "HARV",
    awayRecord: "18-10", homeRecord: "22-5", conference: "Ivy League Semi", time: "11:00 AM PT",
    status: "final", liveScore: { away: 62, home: 60, clock: "FINAL" },
    spread: { fav: "HARV", line: -3.5 }, total: 164.5, moneyline: { away: 155, home: -185 },
    stats: {
      awayPPG: 76.8, homePPG: 79.5, awayOPPG: 73.2, homeOPPG: 68.1,
      awayPace: 70.0, homePace: 69.5, awayFGPct: 0.448, homeFGPct: 0.465,
      away3Pct: 0.342, home3Pct: 0.371, awayFTPct: 0.741, homeFTPct: 0.812,
      awayRebPG: 33.5, homeRebPG: 35.9, awayTOPG: 12.1, homeTOPG: 10.5,
      awayAdjOE: 112.0, homeAdjOE: 116.5, awayAdjDE: 106.2, homeAdjDE: 100.8,
      awayHomeRec: "8-5 Away", homeHomeRec: "12-2 Home", awayLast5: "3-2", homeLast5: "4-1",
      awayATS: "Split 2 reg season", homeATS: "#2 FT% in nation",
      h2hTrend: "Split regular season by 4 total pts", overTrend: "OVER in 6 of last 8 matchups"
    }
  },
  {
    id: 4, away: "Ole Miss", home: "Arkansas", awayAbbr: "MISS", homeAbbr: "ARK",
    awayRecord: "15-19", homeRecord: "24-8", conference: "SEC Semi", time: "12:30 PM PT",
    status: "final", liveScore: { away: 90, home: 93, clock: "FINAL" },
    spread: { fav: "ARK", line: -9.5 }, total: 158.5, moneyline: { away: 370, home: -485 },
    stats: {
      awayPPG: 74.1, homePPG: 82.6, awayOPPG: 77.8, homeOPPG: 70.4,
      awayPace: 68.5, homePace: 72.0, awayFGPct: 0.432, homeFGPct: 0.471,
      away3Pct: 0.328, home3Pct: 0.358, awayFTPct: 0.718, homeFTPct: 0.762,
      awayRebPG: 33.2, homeRebPG: 37.8, awayTOPG: 13.2, homeTOPG: 10.5,
      awayAdjOE: 108.5, homeAdjOE: 121.8, awayAdjDE: 110.2, homeAdjDE: 99.1,
      awayHomeRec: "7-9 Away", homeHomeRec: "17-1 Home", awayLast5: "3-2", homeLast5: "4-1",
      awayATS: "Won 80-79 vs ALA", homeATS: "82-79 W vs OKLA",
      h2hTrend: "ARK won last meeting 94-87", overTrend: "OVER in 7 of last 10 MISS games at this line"
    }
  },
  {
    id: 5, away: "Purdue", home: "UCLA", awayAbbr: "PUR", homeAbbr: "UCLA",
    awayRecord: "25-8", homeRecord: "23-10", conference: "Big Ten Semi", time: "12:30 PM PT",
    status: "final", liveScore: { away: 73, home: 66, clock: "FINAL" },
    spread: { fav: "PUR", line: -7.5 }, total: 143.5, moneyline: { away: -325, home: 260 },
    stats: {
      awayPPG: 77.8, homePPG: 74.2, awayOPPG: 72.1, homeOPPG: 71.8,
      awayPace: 66.5, homePace: 67.2, awayFGPct: 0.468, homeFGPct: 0.445,
      away3Pct: 0.355, home3Pct: 0.338, awayFTPct: 0.778, homeFTPct: 0.745,
      awayRebPG: 38.1, homeRebPG: 34.5, awayTOPG: 10.8, homeTOPG: 11.5,
      awayAdjOE: 119.5, homeAdjOE: 113.2, awayAdjDE: 101.8, homeAdjDE: 103.5,
      awayHomeRec: "12-5 Away", homeHomeRec: "17-1 Home", awayLast5: "4-1", homeLast5: "3-2",
      awayATS: "Oscar Cluff key interior", homeATS: "Lost Bilodeau to injury",
      h2hTrend: "UCLA won 88-84 yesterday but lost key player", overTrend: "OVER in 13 of PUR last 20 games"
    }
  },
  {
    id: 6, away: "St. Joseph's", home: "VCU", awayAbbr: "JOES", homeAbbr: "VCU",
    awayRecord: "22-10", homeRecord: "25-7", conference: "A-10 Semi", time: "12:30 PM PT",
    status: "final", liveScore: { away: 64, home: 77, clock: "FINAL" },
    spread: { fav: "VCU", line: -6.5 }, total: 146.5, moneyline: { away: 245, home: -305 },
    stats: {
      awayPPG: 73.5, homePPG: 76.8, awayOPPG: 68.2, homeOPPG: 65.5,
      awayPace: 66.8, homePace: 67.5, awayFGPct: 0.451, homeFGPct: 0.462,
      away3Pct: 0.348, home3Pct: 0.358, awayFTPct: 0.762, homeFTPct: 0.748,
      awayRebPG: 34.2, homeRebPG: 36.8, awayTOPG: 11.5, homeTOPG: 10.2,
      awayAdjOE: 114.2, homeAdjOE: 118.5, awayAdjDE: 102.5, homeAdjDE: 98.8,
      awayHomeRec: "13-3 Away", homeHomeRec: "15-2 Home", awayLast5: "5-0", homeLast5: "4-1",
      awayATS: "7-0 ATS last 7", homeATS: "14-1 SU last 15",
      h2hTrend: "VCU 9-0 SU vs JOES last 9", overTrend: "UNDER in 8 of JOES last 11"
    }
  },
  {
    id: 7, away: "Tulsa", home: "Wichita State", awayAbbr: "TLSA", homeAbbr: "WICH",
    awayRecord: "26-6", homeRecord: "20-12", conference: "AAC Semi", time: "2:30 PM PT",
    status: "live", liveScore: { away: 24, home: 26, clock: "5:48 1H" },
    spread: { fav: "TLSA", line: -1.5 }, total: 149.5, moneyline: { away: -130, home: 110 },
    stats: {
      awayPPG: 80.2, homePPG: 72.5, awayOPPG: 69.8, homeOPPG: 70.1,
      awayPace: 70.5, homePace: 66.8, awayFGPct: 0.472, homeFGPct: 0.438,
      away3Pct: 0.365, home3Pct: 0.332, awayFTPct: 0.771, homeFTPct: 0.742,
      awayRebPG: 36.5, homeRebPG: 35.8, awayTOPG: 10.8, homeTOPG: 12.5,
      awayAdjOE: 120.8, homeAdjOE: 110.5, awayAdjDE: 101.5, homeAdjDE: 104.2,
      awayHomeRec: "13-2 Away", homeHomeRec: "12-4 Home", awayLast5: "4-1", homeLast5: "3-2",
      awayATS: "Played 3OT yesterday vs UNT", homeATS: "Fresh, rested",
      h2hTrend: "WICH won regular season meeting", overTrend: "Fatigue — TLSA played 55 min yesterday"
    }
  },
  {
    id: 8, away: "Houston", home: "Arizona", awayAbbr: "HOU", homeAbbr: "ARIZ",
    awayRecord: "28-5", homeRecord: "31-2", conference: "Big 12 Final", time: "3:00 PM PT",
    status: "scheduled",
    spread: { fav: "ARIZ", line: -2.5 }, total: 137.5, moneyline: { away: 125, home: -150 },
    stats: {
      awayPPG: 76.5, homePPG: 82.8, awayOPPG: 62.1, homeOPPG: 64.5,
      awayPace: 65.2, homePace: 69.8, awayFGPct: 0.458, homeFGPct: 0.485,
      away3Pct: 0.342, home3Pct: 0.372, awayFTPct: 0.728, homeFTPct: 0.768,
      awayRebPG: 38.5, homeRebPG: 37.2, awayTOPG: 10.2, homeTOPG: 11.5,
      awayAdjOE: 125.7, homeAdjOE: 128.5, awayAdjDE: 93.3, homeAdjDE: 92.8,
      awayHomeRec: "12-3 Away", homeHomeRec: "16-1 Home", awayLast5: "5-0", homeLast5: "5-0",
      awayATS: "69-47 W vs Kansas", homeATS: "82-80 W vs ISU",
      h2hTrend: "ARIZ won reg season 73-66", overTrend: "HOU #5 Adj DE, ARIZ #3 — defensive battle"
    }
  },
  {
    id: 9, away: "UConn", home: "St. John's", awayAbbr: "CONN", homeAbbr: "SJU",
    awayRecord: "28-5", homeRecord: "26-6", conference: "Big East Final", time: "3:30 PM PT",
    status: "scheduled",
    spread: { fav: "CONN", line: -3.5 }, total: 140.5, moneyline: { away: -150, home: 130 },
    stats: {
      awayPPG: 80.2, homePPG: 76.8, awayOPPG: 65.5, homeOPPG: 66.2,
      awayPace: 67.8, homePace: 65.5, awayFGPct: 0.498, homeFGPct: 0.441,
      away3Pct: 0.368, home3Pct: 0.335, awayFTPct: 0.772, homeFTPct: 0.755,
      awayRebPG: 37.8, homeRebPG: 36.2, awayTOPG: 10.5, homeTOPG: 11.8,
      awayAdjOE: 124.5, homeAdjOE: 115.8, awayAdjDE: 94.2, homeAdjDE: 96.5,
      awayHomeRec: "14-2 Away", homeHomeRec: "14-1 Home", awayLast5: "5-0", homeLast5: "4-1",
      awayATS: "UNDER 14 of last 18 postseason", homeATS: "UNDER 8 of last 9",
      h2hTrend: "Split reg season, combined 153 at MSG", overTrend: "SJU 49% inside arc in Big East"
    }
  },
  {
    id: 10, away: "Virginia", home: "Duke", awayAbbr: "UVA", homeAbbr: "DUKE",
    awayRecord: "24-8", homeRecord: "30-2", conference: "ACC Final", time: "5:30 PM PT",
    status: "scheduled",
    spread: { fav: "DUKE", line: -8.5 }, total: 137.5, moneyline: { away: 310, home: -400 },
    stats: {
      awayPPG: 72.5, homePPG: 81.2, awayOPPG: 63.8, homeOPPG: 62.5,
      awayPace: 62.5, homePace: 68.2, awayFGPct: 0.455, homeFGPct: 0.488,
      away3Pct: 0.358, home3Pct: 0.375, awayFTPct: 0.782, homeFTPct: 0.768,
      awayRebPG: 35.5, homeRebPG: 38.8, awayTOPG: 9.8, homeTOPG: 11.2,
      awayAdjOE: 116.2, homeAdjOE: 126.8, awayAdjDE: 92.5, homeAdjDE: 91.2,
      awayHomeRec: "10-5 Away", homeHomeRec: "16-0 Home", awayLast5: "5-0", homeLast5: "4-1",
      awayATS: "84-62 W vs Miami", homeATS: "Missing Foster & Ngongba",
      h2hTrend: "DUKE won 77-51 on Jan 28", overTrend: "UVA plays slowest pace in ACC"
    }
  }
];
...
async function loadWeights() {
  try { const r = localStorage.getItem("jsd-weights-v2"); return r ? { ...DEFAULT_WEIGHTS, ...JSON.parse(r) } : { ...DEFAULT_WEIGHTS }; }
  catch { return { ...DEFAULT_WEIGHTS }; }
}
async function saveWeights(w) {
  try { localStorage.setItem("jsd-weights-v2", JSON.stringify(w)); } catch(e) { console.error(e); }
}
async function loadHistory() {
  try { const r = localStorage.getItem("jsd-history-v2"); return r ? JSON.parse(r) : []; }
  catch { return []; }
}
async function saveHistory(h) {
  try { localStorage.setItem("jsd-history-v2", JSON.stringify(h.slice(-200))); } catch(e) { console.error(e); }
}
...
async function loadTeamCal() {
  try { const r = localStorage.getItem("jsd-teamcal-v1"); return r ? JSON.parse(r) : {}; }
  catch { return {}; }
}
async function saveTeamCal(c) {
  try { localStorage.setItem("jsd-teamcal-v1", JSON.stringify(c)); } catch(e) { console.error(e); }
}
...
// ─── AI REFRESH ───
function getApiKey() { return localStorage.getItem("jsd-anthropic-key") || ""; }

async function fetchLiveUpdates(games) {
  const key = getApiKey();
  if (!key) throw new Error("API key required — tap ⚙️ to set it");
  const gameList = games.map(g =>
    `Game ${g.id}: ${g.awayAbbr} vs ${g.homeAbbr} (${g.conference}), pregame spread: ${g.spread.fav} ${g.spread.line}, pregame O/U: ${g.total}`
  ).join("\n");
  ...
  const resp = await fetch("https://api.anthropic.com/v1/messages", {
    ...
    body: JSON.stringify({
      ...
      messages: [{ role: "user", content: `Today is Saturday March 14, 2026. You are a sports data assistant. Search ESPN, CBS Sports, or any live scores site for the CURRENT status of these college basketball games:

${gameList}

For EACH game, search and find:
1. Current live score OR final score (search "college basketball scores today March 14 2026")
2. Current live betting O/U total line (search "NCAAB live odds today" or "college basketball live betting lines March 14 2026") — this is the CURRENT line, which changes during the game
3. Current live spread
4. Any injury news from TODAY
5. Any notable in-game trends (hot/cold shooting, runs, foul trouble)

IMPORTANT: For live games, the O/U line changes during the game based on scoring pace. Find the CURRENT live total, not the pregame total.

Respond with ONLY a valid JSON array, no markdown, no backticks, no explanation. Each element must be:
{"id":<number 1-10>,"status":"scheduled"|"live"|"final","awayScore":<number or null>,"homeScore":<number or null>,"clock":"<string or null>","currentTotal":<current O/U line number or null if unknown>,"currentSpread":"<e.g. 'MICH -10.5' or null>","injuries":"<brief string or null>","trend":"<brief string or null>","awayScoreAdj":<number, positive if team playing above avg, negative if below>,"homeScoreAdj":<number same>}
...
export default function App() {
  ...
  const [history, setHistory] = useState([
    // Pre-seeded from today's completed games (Mar 14, 2026)
    { gameId:1,away:"VAN",home:"FLA",predictedTotal:158.6,actualTotal:165,totalCall:"UNDER",line:160.5,totalCorrect:false,spreadCorrect:false,totalError:6.4,date:"2026-03-14" },
    { gameId:2,away:"WIS",home:"MICH",predictedTotal:169.5,actualTotal:133,totalCall:"OVER",line:162.5,totalCorrect:false,spreadCorrect:false,totalError:-36.5,date:"2026-03-14" },
    { gameId:3,away:"PENN",home:"HARV",predictedTotal:155.9,actualTotal:122,totalCall:"UNDER",line:164.5,totalCorrect:true,spreadCorrect:true,totalError:-33.9,date:"2026-03-14" },
    { gameId:4,away:"MISS",home:"ARK",predictedTotal:156.7,actualTotal:183,totalCall:"UNDER",line:158.5,totalCorrect:false,spreadCorrect:false,totalError:26.3,date:"2026-03-14" },
    { gameId:5,away:"PUR",home:"UCLA",predictedTotal:149.5,actualTotal:139,totalCall:"OVER",line:143.5,totalCorrect:false,spreadCorrect:true,totalError:-10.5,date:"2026-03-14" },
    { gameId:6,away:"JOES",home:"VCU",predictedTotal:148.9,actualTotal:141,totalCall:"OVER",line:146.5,totalCorrect:false,spreadCorrect:true,totalError:-7.9,date:"2026-03-14" },
  ]);
  const [log, setLog] = useState(null);
  const [teamCal, setTeamCal] = useState({});
  const [showBacktest, setShowBacktest] = useState(false);
  const [apiKey, setApiKey] = useState(() => (typeof localStorage !== 'undefined' ? localStorage.getItem("jsd-anthropic-key") : "") || "");
  const [showKeyInput, setShowKeyInput] = useState(false);

  useEffect(()=>{(async()=>{setWeights(await loadWeights());setHistory(await loadHistory());setTeamCal(await loadTeamCal());})();},[]);

  const handleRefresh = useCallback(async()=>{
    setRefreshing(true); setLog("Searching for live scores, lines & injuries...");
    try {
      const updates = await fetchLiveUpdates(games);
      if(updates&&Array.isArray(updates)){
        ...
        const ug=games.map(g=>{
          ...
          // Update betting lines if AI found current ones
          let lineNote = null;
          ...
          if(u.currentSpread && u.currentSpread !== "null"){
            // Parse spread like "MICH -10.5" or "FLA -4"
          ...
          if(u.status==="final"&&u.awayScore!=null&&u.homeScore!=null){
            ...
            if(!history.find(h=>h.gameId===g.id)){
              const rec={gameId:g.id,away:g.awayAbbr,home:g.homeAbbr,predictedTotal:pred.predictedTotal,actualTotal:at,predictedSpread:pred.predictedSpread,actualSpread:as,totalCall:pred.totalCall,line:g.total,totalCorrect:tOk,spreadCorrect:sOk,totalError:at-pred.predictedTotal,date:new Date().toISOString()};
              const nh=[...history,rec]; setHistory(nh); saveHistory(nh);
              const learned=learnFromResult(weights,pred,at,teamCal,g.awayAbbr,g.homeAbbr,u.awayScore,u.homeScore);
              setWeights(learned.weights); saveWeights(learned.weights);
              setTeamCal(learned.teamCal); saveTeamCal(learned.teamCal);
            }
          }
          return ng;
        });
        ...
        setLog(`Updated: ${live} live, ${finals} final, ${lineChanges} line moves${finals?" — model learning!":""}`);
      } else { setLog("Couldn't parse response — try again"); }
    } catch(e){ setLog("Error: "+e.message); }
    setRefreshing(false);
  },[games,weights,history]);

  const fg = filter==="all"?games:filter==="live"?games.filter(g=>g.status==="live"):filter==="final"?games.filter(g=>g.status==="final"):filter==="power"?games.filter(g=>["Big Ten Semi","SEC Semi","Big 12 Final","Big East Final","ACC Final"].includes(g.conference)):games;
  const oc=games.filter(g=>predictGame(g,weights,liveAdj[g.id],teamCal).totalCall==="OVER").length;
  const edgeCount=games.filter(g=>predictGame(g,weights,liveAdj[g.id],teamCal).hasEdge).length;
  const ac=Math.round(games.reduce((a,g)=>a+predictGame(g,weights,liveAdj[g.id],teamCal).confidence,0)/games.length);
  const bt = runBacktest(weights, teamCal);
  ...
  return (
    <div style={{"--bg":"#0a0a0f","--card-bg":"#12121a","--card-header":"#0e0e16","--border":"#1e1e2e","--text":"#e8e8f0","--text-secondary":"#a0a0b8","--muted":"#5a5a78","--accent":"#6366f1","--pred-bg":"#6366f108","--pred-border":"#6366f120","--lines-bg":"#0a0a12","--pill-bg":"#1a1a28","--pill-active":"#6366f1",minHeight:"100vh",background:"var(--bg)",fontFamily:"'Inter',-apple-system,sans-serif",color:"var(--text)",maxWidth:"520px",margin:"0 auto",padding:"0"}}>
      ...
      <div style={{ padding:"28px 20px 20px",background:"linear-gradient(180deg,#12121f 0%,#0a0a0f 100%)",borderBottom:"1px solid var(--border)" }}>
        <div style={{ display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:"4px" }}>
          ...
          <div style={{ display:"flex",gap:"6px" }}>
            ...
            <button onClick={()=>setShowKeyInput(!showKeyInput)} style={{ background:"var(--pill-bg)",color:"var(--muted)",border:"none",borderRadius:"10px",padding:"8px 10px",fontSize:"13px",cursor:"pointer" }}>⚙️</button>
          </div>
        </div>
        {showKeyInput && (
          <div style={{ marginBottom:"12px",padding:"10px",borderRadius:"8px",background:"var(--card-bg)",border:"1px solid var(--border)" }}>
            <div style={{ fontSize:"10px",color:"var(--muted)",marginBottom:"6px",fontWeight:600 }}>Anthropic API Key (stored locally only)</div>
            <div style={{ display:"flex",gap:"6px" }}>
              <input type="password" value={apiKey} onChange={e=>{setApiKey(e.target.value);localStorage.setItem("jsd-anthropic-key",e.target.value);}} placeholder="sk-ant-..." style={{ flex:1,background:"var(--lines-bg)",border:"1px solid var(--border)",borderRadius:"6px",padding:"6px 10px",color:"var(--text)",fontSize:"12px",fontFamily:"'JetBrains Mono',monospace",outline:"none" }} />
              <button onClick={()=>setShowKeyInput(false)} style={{ background:"var(--accent)",color:"#fff",border:"none",borderRadius:"6px",padding:"6px 12px",fontSize:"11px",fontWeight:700,cursor:"pointer" }}>Save</button>
            </div>
            <div style={{ fontSize:"9px",color:"var(--muted)",marginTop:"4px" }}>Get one at console.anthropic.com — stored in your browser only</div>
          </div>
        )}
        <div style={{ display:"flex",alignItems:"center",gap:"8px",marginBottom:"16px" }}>
          <p style={{ fontSize:"12px",color:"var(--muted)",fontWeight:500 }}>Conf Tournaments • Sat, March 14, 2026</p>
        ...
        <div style={{ display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:"8px",marginBottom:"16px" }}>
          {[{l:"Games",v:games.length,i:"📊"},{l:"Over / Under",v:`${oc}/${games.length-oc}`,i:"🎯"},{l:"Edges (3+)",v:edgeCount,i:"⚡"}].map((x,i)=>(
        ...
        <div style={{ display:"flex",gap:"6px",flexWrap:"wrap" }}>
          {[{k:"all",l:"All"},{k:"live",l:"Live"},{k:"final",l:"Final"},{k:"power",l:"Power 5"}].map(f=>(
      ...
      <div style={{ margin:"0 12px 10px" }}>
        <button onClick={()=>setShowBacktest(!showBacktest)} style={{ width:"100%",background:"var(--card-bg)",border:"1px solid var(--border)",borderRadius:"10px",padding:"10px 14px",color:"var(--accent)",fontSize:"11px",fontWeight:700,cursor:"pointer",display:"flex",justifyContent:"space-between",alignItems:"center",textTransform:"uppercase",letterSpacing:"0.5px" }}>
          <span>📋 Yesterday's Backtest: {bt.totalPct}% O/U, {bt.spreadPct}% ATS ({bt.n} games)</span>
          <span style={{ fontSize:"14px" }}>{showBacktest?"▲":"▼"}</span>
        </button>
        {showBacktest && (
          <div style={{ background:"var(--card-bg)",border:"1px solid var(--border)",borderTop:"none",borderRadius:"0 0 10px 10px",padding:"12px",animation:"fadeIn 0.3s ease" }}>
            <div style={{ display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:"8px",marginBottom:"10px" }}>
              {[{l:"O/U",v:`${bt.totalCorrect}/${bt.n}`,c:+bt.totalPct>=55?"#22c55e":"#eab308"},{l:"ATS",v:`${bt.spreadCorrect}/${bt.n}`,c:+bt.spreadPct>=55?"#22c55e":"#eab308"},{l:"Avg Err",v:`${bt.avgError} pts`,c:+bt.avgError<8?"#22c55e":"#eab308"}].map((x,i)=>(
                <div key={i} style={{ textAlign:"center",padding:"6px",borderRadius:"6px",background:"var(--lines-bg)" }}>
                  <div style={{ fontSize:"14px",fontWeight:800,fontFamily:"'JetBrains Mono',monospace",color:x.c }}>{x.v}</div>
                  <div style={{ fontSize:"9px",color:"var(--muted)",fontWeight:600,textTransform:"uppercase" }}>{x.l}</div>
                </div>
              ))}
            </div>
            <div style={{ maxHeight:"200px",overflowY:"auto" }}>
              {bt.results.map((r,i)=>(
                <div key={i} style={{ display:"flex",justifyContent:"space-between",alignItems:"center",padding:"4px 0",borderBottom:"1px solid var(--border)",fontSize:"11px" }}>
                  <span style={{ color:"var(--text)",fontWeight:600,minWidth:"80px" }}>{r.away}@{r.home}</span>
                  <span style={{ fontFamily:"'JetBrains Mono',monospace",color:"var(--muted)",fontSize:"10px" }}>P:{r.predTotal.toFixed(0)} A:{r.actual} L:{r.line}</span>
                  <span style={{ display:"flex",gap:"4px" }}>
                    <span style={{ color:r.tOk?"#22c55e":"#ef4444",fontWeight:700,fontSize:"10px" }}>{r.tOk?"✓":"✗"}O/U</span>
                    <span style={{ color:r.sOk?"#22c55e":"#ef4444",fontWeight:700,fontSize:"10px" }}>{r.sOk?"✓":"✗"}ATS</span>
                  </span>
                </div>
              ))}
            </div>
      ...
      <div style={{ margin:"0 12px",padding:"12px 14px",borderRadius:"10px",background:"var(--pred-bg)",border:"1px solid var(--pred-border)" }}>
        <div style={{ fontSize:"10px",fontWeight:700,color:"var(--accent)",textTransform:"uppercase",letterSpacing:"1px",marginBottom:"6px" }}>Self-Learning Model v2</div>
        <div style={{ fontSize:"11px",color:"var(--text-secondary)",lineHeight:1.6 }}>
          <strong style={{color:"var(--text)"}}>Pace projection</strong> — models actual game tempo using opponent defense interaction (slower team controls ~60%). <strong style={{color:"var(--text)"}}>Per-team calibration</strong> — learns team-specific biases over time. <strong style={{color:"var(--text)"}}>Backtesting</strong> — validates against yesterday's {bt.n} completed games. Only flags <strong style={{color:"#f59e0b"}}>3+ point edges</strong> vs Vegas.
          {weights.totalBias !== 0 && <span style={{ display:"block",marginTop:"4px",color:"#a855f7" }}>🧠 Global bias: {weights.totalBias>0?"+":""}{weights.totalBias.toFixed(2)} | Tourney: {weights.tourneyFactor.toFixed(3)}</span>}
          {Object.keys(teamCal).length > 0 && <span style={{ display:"block",marginTop:"2px",color:"#a855f7",fontSize:"10px" }}>📊 Team cal: {Object.entries(teamCal).slice(0,8).map(([t,v])=>`${t} ${v.bias>0?"+":""}${v.bias.toFixed(1)}`).join(", ")}{Object.keys(teamCal).length>8?" ...":""}</span>}
        </div>
      </div>
